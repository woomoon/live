...
public class UserController {
    ...
    //查询所有的门诊医师的名字
    @RequestMapping("queryAllMZ")
    @ResponseBody
    List<UserEntity> queryAllMZ(){
        return userMapper.queryAllMZ();
    }

    //查询所有的主治医师的名字
    @RequestMapping("queryAllZZ")
    @ResponseBody
    List<UserEntity> queryAllZZ(){
        return userMapper.queryAllZZ();
    }

    //查询所有的主任医师的名字
    @RequestMapping("queryAllZR")
    @ResponseBody
    List<UserEntity> queryAllZR(){
        return userMapper.queryAllZR();
    }
